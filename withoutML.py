...
happy_dict = {
   'happy' :0.8 ,  'joy': 0.9, 'elation': 0.8, 'cheerful': 1.0, 'uplifting': 0.9, 'contentment': 0.7, 'bliss': 0.8, 'satisfaction': 0.9,
    ...
    'relaxed': 0.7, 'peaceful': 0.8, 'optimistic': 0.9, 'thankful': 1.0, 'celebrating': 0.8
}

sad_dict = {
    'sad': 0.8, 'unhappy': 0.7, 'melancholy': 0.9, 'grief': 0.8, 'despair': 0.7, 'tearful': 0.8, 'heartache': 0.7,
...
fear_dict = {
    ...
    'nervousness': 0.9, 'shivers': 0.8, 'apprehensive': 0.7, 'foreboding': 0.8, 'disquiet': 0.9, 'uneasiness': 0.8
}
